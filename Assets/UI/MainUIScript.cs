...
public class MainUIScripts : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var leftVisual = root.Q<VisualElement>("LeftVisual");
        healthLabel = leftVisual.Q<Label>("Health");
        pointLabel = leftVisual.Q<Label>("Point");

        var rightVisual = root.Q<VisualElement>("RightVisual");
        waveLabel = rightVisual.Q<Label>("Wave");
        enemiesLeftLabel = rightVisual.Q<Label>("EnemiesLeft");
    ...
    void Update()
    {
        ...
        pointLabel.text = $"Point: {(combatManager != null ? combatManager.score : 0)}";
